...
<body>
    ...
    <div class="box">
        <h1 class="h">회원가입</h1>
        <form action="MemberRegisterPro.jsp">
        <table >
            <tr>
                <th class="k" colspan="2"><br> 기본정보</th>
            </tr>
            <tr>
                <td><label for="name">이름</label></td>
                <td class="input"><input type="text" name="name" id="name" size="15" ></td>
            </tr>
            <tr>
                <td><label for="id">아이디</label></td>
                <td class="input"><input type="text" name="id" id="id" size="15"></td>
            </tr>
            <tr>
                <td><label for="password">비밀번호</label></td>
                <td class="input"><input type="password" name="passwd" id="password" size="15"></td>
            </tr>
            <tr>
                <td><label for="text">주소</label></td>
                <td class="input"><input type="text" name="address" id="text" size="50"></td>
            </tr>
            <tr>
                <td><label for="email">이메일</label></td>
                <td class="input"><input type="text" name="email1" id="email" size="15">@
                    <select name="email2">
                    <option value="naver">naver.com</option>
                    <option value="goolgle">gmail.com</option>
                    <option value="daum">daum.net</option>
                    </select>
                </td>
            </tr>
            <tr>
                <td><label for="number">휴대폰</label></td>
                <td class="input">
                    <select name="tel1">
                    ...
                    -
                    <input type="text" name="tel2" id="number" size="15">
                    -
                    <input type="text" name="tel3" id="number" size="15">
                </td>
            </tr>
        </table>
